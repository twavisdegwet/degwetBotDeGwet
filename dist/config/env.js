...
const envSchema = zod_1.z.object({
    ...
    TORRENT_BASE_URL: zod_1.z.string().url().default('https://www.myanonamouse.net'),
    ...
    GOOGLE_SERVICE_ACCOUNT_JSON: zod_1.z.string().min(1),
    ...
    COMIC_IMAGE_PATH: zod_1.z.string().min(1).default('/path/to/comics'),
    BOT_DISPLAY_NAME: zod_1.z.string().optional().default('BookBot'),
