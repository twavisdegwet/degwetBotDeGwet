...
export async function execute(interaction: ChatInputCommandInteraction) {
    ...
    try {
        ...
        const jokeTask = `You are a Discord bot that tells terrible jokes. Every joke MUST end have something to do with garfield. Ideally something about odie or how much he hates jon or lasagna or hating mondays.`;
